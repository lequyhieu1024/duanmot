...
<body>
    ...
    <tbody>
        <?php
        $sql = "SELECT * FROM tai_khoan WHERE id_role = 2 OR id_role = 3";
        ...
        <tr>
            ...
            <th scope="col"><img src="../../../pubic/images/" alt=""></th>
            <th scope="col"><?=$email?></th>
            ...
            <td><a href=""><button class="btn btn-warning">Sửa</button></a>
                <a href="index.php?act=delete&header=taikhoanqtv&id=id_tai_khoan&table=tai_khoan&iddl=<?=$id_tai_khoan;?>"><button class="btn btn-danger">Xóa</button></a>
            </td>       
        </tr>
        <?php endforeach; ?>
    </tbody>
