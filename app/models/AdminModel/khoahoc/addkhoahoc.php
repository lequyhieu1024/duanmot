...
if (isset($_POST["addkhoahoc"])) {
    ...
    $sql = "INSERT INTO khoa_hoc(ten_khoa_hoc, avt, tien_hoc, mo_ta, trang_thai, id_giang_vien, id_danh_muc, slideshow) VALUES ('$ten_khoa_hoc','$avt','$tien_hoc','$mo_ta','$trang_thai','$id_giang_vien','$ma_danh_muc','$slideshow')";
    pdo_execute($sql);
            ...
            <div class="form-group">
                ...
                <select name="id_giang_vien" id="">
                    <?php
                        ...
                        extract($row);?>
                        <option value="<?=$id_giang_vien;?>"><?=$id_giang_vien;?></option>
                    <?php endforeach;?>
                </select>
            </div>
            <div class="form-group">
