...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 27, 2023 lúc 10:20 AM
...
(12, 1, 23, 4, 2000, '2023-11-02', '3', 1, NULL, NULL, NULL),
(14, 1, 30, 4, 123, '2023-11-02', '3', 0, NULL, NULL, NULL),
(27, 1, 38, 4, 100, '2023-11-27', '1', 8, 'Hiếu Huân Tuấn', '012345678911', 'codephpnguvl@gmail.com'),
(28, 1, 38, 4, 78, '2023-11-27', '1', 4, 'Hiếu Huân Tuấn', '012345678911', 'codephpnguvl@gmail.com'),
(30, 1, 37, 4, 110811, '2023-11-27', '1', 8, 'Hiếu Huân Tuấn', '012345678911', 'codephpnguvl@gmail.com'),
(31, 57, 25, 4, 86, '2023-11-27', '1', 4, 'LLLLLE QUYYY HIEUUUU', '0338475943', 'hieulqph36904@fpt.edu.vn');
...
--
ALTER TABLE `binh_luan`
  MODIFY `id_binh_luan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT cho bảng `dang_ky_khoa_hoc`
--
ALTER TABLE `dang_ky_khoa_hoc`
  MODIFY `id_dang_ky_khoa_hoc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `khoa_hoc`
  MODIFY `id_khoa_hoc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `lo_trinh_khoa_hoc`
  MODIFY `id_lo_trinh_khoa_hoc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
